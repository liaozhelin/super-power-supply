...
//GPIO置位（拉高）
#define	LCD_CS_SET  GPIOB->BSRR=1<<15    //片选端口  	  PB15
#define	LCD_RS_SET	GPIOC->BSRR=1<<12  //数据/命令        PC12  
#define	LCD_RST_SET	GPIOD->BSRR=1<<2   //复位			 PD2

//GPIO复位（拉低）							    
#define	LCD_CS_CLR  GPIOB->BRR=1<<15   //片选端口  	     PB15
#define	LCD_RS_CLR	GPIOC->BRR=1<<12   //数据/命令        PC12	 
#define	LCD_RST_CLR	GPIOD->BRR=1<<2    //复位			 PD2
